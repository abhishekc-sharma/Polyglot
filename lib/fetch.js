...
function getCommitInfoUrl(repo) {
  ...
  const ACCESS_TOKEN = 'd638342a492fcc573e0849cfb6fdfa5bf6602bfb'; // Will probably have to change how this is obtained
...
function getCommitFileList(commitTree, {language, owner, name, extensions}) {
  return commitTree.filter(file => extensions.indexOf(fileExtension(file.path)) !== -1)
